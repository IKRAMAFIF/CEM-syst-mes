% tp03.m - FDTD avec dimensions de cavité et pas spatial modifiés
...
% Cavity dimensions in meters - MODIFIÉES
Lx = 6.7; Ly = 8.4; Lz = 3.5; 
% Number of cells in each direction - RECALCULÉES pour delta = 0.1
Nx =  67; Ny =  84; Nz =  35; 
